...
function App() {
  return (
    // A flex column at least a viewport tall, so a short page (the events
    // list, an event that was not found) still keeps the footer at the foot
    // of the window rather than floating up under the content.
    <div className="relative isolate flex min-h-svh flex-col overflow-hidden text-brand-deep">
