  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-shell items-center justify-between px-6 py-4 sm:px-8 lg:px-10 xl:px-14">
        ...
        <button
          type="button"
          className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-brand-rose/70 bg-white/65 text-brand-deep shadow-soft transition duration-300 ease-out hover:-translate-y-1 hover:scale-105 hover:bg-brand-hover md:hidden"
