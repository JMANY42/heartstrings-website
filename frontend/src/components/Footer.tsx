      ...
      <div className="mx-auto flex max-w-shell flex-col gap-6 md:flex-row md:items-end md:justify-between">
        ...
        <div className="flex flex-col items-start gap-4 md:items-end">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-3 rounded-full border border-brand-rose/55 bg-white/75 px-5 py-3 shadow-[0_18px_50px_rgba(201,116,143,0.1)] transition duration-300 ease-out hover:-translate-y-1 hover:bg-brand-hover"
